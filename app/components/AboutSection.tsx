      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base lg:text-lg">
            I am a student at UTRGV and the career path i am going into is computer science. 
            I am planning to go into game development at Full Sail University once I get my degree here. 

            My enthusiasm for this career has come from my childhood. I have always
             loved to play games but I wanted to know more.
          </p>
